  ...
  return (
    <section className="container mx-auto px-6 py-6 lg:py-8">
      <div className="relative mt-6 flex flex-row items-center justify-center lg:mt-32 2xl:mt-40">
        <img
          className=" absolute right-32 hidden h-[108px] w-[108px] Pulse lg:right-16 lg:flex xl:right-24 xl:h-[128px] xl:w-[128px] 2xl:right-52"
          src={wallet}
          alt=""
        />
        ...
        <img
          className="absolute left-32 hidden h-[108px] w-[108px] Pulse lg:left-16 lg:flex xl:left-24 xl:h-[128px] xl:w-[128px] 2xl:left-52"
          src={walletbtc}
          alt=""
        />
      </div>
